...
#button
button = ctk.CTkButton(right_frame, text="Download", width=80, height=32, corner_radius=8,fg_color="#5DD9D9" ,hover_color="#A0F2F2", border_color="#464A4A", border_width=2, font=ctk.CTkFont(size=10, weight="bold"))
